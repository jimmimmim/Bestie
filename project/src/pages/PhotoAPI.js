...
function PhotoAPI() {
    ...
    const fetchData = async () => {
        try {
            ...
            const response = await axios.get(`${PROXY}?serviceKey=${process.env.REACT_APP_DATA_API_KEY}&pageNo=${pageNo}&numOfRows=${numOfRows}&MobileOS=${MobileOS}&MobileApp=${MobileApp}&_type=json`)
